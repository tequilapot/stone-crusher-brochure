...
const AboutPage = () => (
 ...
 <span className="text-[20px] text-[#6B7280] font-medium block mt-3 normal-case tracking-normal">For the Mining, Quarrying & Infrastructure Industries</span>
 </h2>
 ...
 <div className="w-full flex-grow min-h-[250px] flex items-center justify-center relative overflow-hidden my-10 group bg-[#F9FAFB]">
 <img
 ...
 <div className="premium-card flex flex-col items-center justify-center text-center py-8">
 <div className="text-[44px] stat-number leading-none mb-3">120<span className="text-[24px] text-[#9CA3AF] align-top">+</span></div>
 <div className="data-label">GLOBAL PROJECTS</div>
 </div>
 <div className="premium-card flex flex-col items-center justify-center text-center py-8">
 <div className="text-[44px] stat-number leading-none mb-3">45<span className="text-[24px] text-[#9CA3AF] align-top">+</span></div>
 <div className="data-label">ENTERPRISE CLIENTS</div>
 </div>
 <div className="premium-card flex flex-col items-center justify-center text-center py-8">
 <div className="text-[44px] stat-number leading-none mb-3">10<span className="text-[24px] text-[#9CA3AF] align-top">+</span></div>
 ...
 <h3 className="section-label mb-6 text-center border-b border-[#E5E7EB] pb-4">
 ...
 {/* Page Footer */}
 <div className="text-[9px] text-[#9CA3AF] font-bold tracking-[0.2em] uppercase flex justify-between border-t border-[#F3F4F6] pt-4 mt-6">
...
const ProjectProfilePage1 = () => {
 ...
 <div className="text-[9px] text-[#9CA3AF] uppercase tracking-[0.2em] mb-0.5">LOCATION</div>
 ...
 {/* 02 / JAW CRUSHER */}
 <div className="relative aspect-[16/7.5] w-full bg-[#F9FAFB] border border-[#E5E7EB] overflow-hidden p-2 shadow-sm flex items-center justify-between group">
 ...
 <p className="text-[11px] text-[#6B7280] leading-tight">30-400 TPH capacity, hydraulic wedge adjustment</p>
 </div>
 </div>
 ...
 <p className="text-[11px] text-[#6B7280] leading-tight">Triple shaft heavy duty screening mechanism</p>
 </div>
 </div>
 ...
 <p className="text-[11px] text-[#6B7280] leading-tight">High efficiency moisture reduction rotary system</p>
 </div>
 </div>
 ...
 <p className="text-[11px] text-[#6B7280] leading-tight">High capacity continuous material handling</p>
 </div>
 </div>
 </div>
 ...
 <div className="bg-white border-t-4 border-[#F2B233] border-x border-b border-[#E5E7EB] p-4 flex flex-col justify-between space-y-3 shadow-sm flex-grow">
 <div>
 ...
 <p className="text-[13px] text-[#4B5563] leading-snug">Building rubble & concrete loaded to feeder.</p>
 </div>
 {/* Step 2 */}
 <div className="relative pl-6 group">
 ...
 <p className="text-[13px] text-[#4B5563] leading-snug">Clears mud, wood bits, and light wastes dynamically.</p>
 </div>
 {/* Step 3 */}
 <div className="relative pl-6 group">
 ...
 <p className="text-[13px] text-[#4B5563] leading-snug">Retrieves reinforcement scrap steel for recycling.</p>
 </div>
 {/* Step 4 */}
 <div className="relative pl-6 group">
 ...
 <p className="text-[13px] text-[#4B5563] leading-snug">Dries processed sand to below 1% moisture.</p>
 </div>
 </div>
 </div>
 ...
 <p className="text-[17px] text-[#4B5563] leading-relaxed font-light">
 ...
 {/* Footer */}
 <div className="flex justify-between items-end mt-4 text-[9px] text-[#9CA3AF] font-bold tracking-[0.2em] uppercase border-t border-[#F3F4F6] pt-4">
...
const CaseStudyPage1 = () => {
 ...
 <p className="text-[13px] text-[#4B5563] leading-snug">Receives raw mountain basalt feed up to 500mm size.</p>
 </div>
 {/* Step 2 */}
 <div className="relative pl-6 group">
 <div className="absolute -left-[15px] top-0 w-7 h-7 rounded-full bg-[#0F172A] text-[#F2B233] flex items-center justify-center text-[12px] font-black shadow-md border-2 border-white group-hover:scale-110 transition-transform">2</div>
 <h5 className="font-bold text-[#0F172A] text-[14px] leading-none mb-1.5 uppercase tracking-wide">Jaw Crusher</h5>
 <p className="text-[13px] text-[#4B5563] leading-snug">SREW 900x600 primary reduction of basalt down to 120mm.</p>
 </div>
 {/* Step 3 */}
 <div className="relative pl-6 group">
 <div className="absolute -left-[15px] top-0 w-7 h-7 rounded-full bg-[#0F172A] text-[#F2B233] flex items-center justify-center text-[12px] font-black shadow-md border-2 border-white group-hover:scale-110 transition-transform">3</div>
 <h5 className="font-bold text-[#0F172A] text-[14px] leading-none mb-1.5 uppercase tracking-wide">Cone Crusher</h5>
 <p className="text-[13px] text-[#4B5563] leading-snug">SREW secondary Cone Crusher resizing feed down to 40mm.</p>
 </div>
 {/* Step 4 */}
 <div className="relative pl-6 group">
 <div className="absolute -left-[15px] top-0 w-7 h-7 rounded-full bg-[#F2B233] text-[#0F172A] flex items-center justify-center text-[12px] font-black shadow-md border-2 border-[#0F172A] group-hover:scale-110 transition-transform">4</div>
 <h5 className="font-bold text-[#0F172A] text-[14px] leading-none mb-1.5 uppercase tracking-wide">Vibrating Screen</h5>
 <p className="text-[13px] text-[#4B5563] leading-snug">Precision classification into 10mm, 20mm, and 40mm outputs.</p>
 </div>
 </div>
 </div>
 ...
 <p className="text-[17px] text-[#4B5563] leading-relaxed font-light">The West Bengal crushing plant successfully delivered over 200 TPH of precision aggregates with high shape-cubicity. In addition, the integration of a sand washing plant allowed the client to capture washed plaster sand on-site, delivering an excellent return on investment within 9 months.</p>
 </div>
...
const CaseStudyPage2 = () => {
 ...
 <p className="text-[13px] text-[#4B5563] leading-snug">Heavy quarry stone fed via automatic apron feeder.</p>
 </div>
 {/* Step 2 */}
 <div className="relative pl-6 group">
 <div className="absolute -left-[15px] top-0 w-7 h-7 rounded-full bg-[#0F172A] text-[#F2B233] flex items-center justify-center text-[12px] font-black shadow-md border-2 border-white group-hover:scale-110 transition-transform">2</div>
 <h5 className="font-bold text-[#0F172A] text-[14px] leading-none mb-1.5 uppercase tracking-wide">Dual Jaw Crusher</h5>
 <p className="text-[13px] text-[#4B5563] leading-snug">SREW dual-toggle Jaw crushers tackle heavy primary crushing.</p>
 </div>
 {/* Step 3 */}
 <div className="relative pl-6 group">
 <div className="absolute -left-[15px] top-0 w-7 h-7 rounded-full bg-[#0F172A] text-[#F2B233] flex items-center justify-center text-[12px] font-black shadow-md border-2 border-white group-hover:scale-110 transition-transform">3</div>
 <h5 className="font-bold text-[#0F172A] text-[14px] leading-none mb-1.5 uppercase tracking-wide">Grizzly Feeder</h5>
 <p className="text-[13px] text-[#4B5563] leading-snug">Bypasses pre-crushed materials to secondary circuit.</p>
 </div>
 {/* Step 4 */}
 <div className="relative pl-6 group">
 <div className="absolute -left-[15px] top-0 w-7 h-7 rounded-full bg-[#F2B233] text-[#0F172A] flex items-center justify-center text-[12px] font-black shadow-md border-2 border-[#0F172A] group-hover:scale-110 transition-transform">4</div>
 <h5 className="font-bold text-[#0F172A] text-[14px] leading-none mb-1.5 uppercase tracking-wide">HSI Crusher</h5>
 <p className="text-[13px] text-[#4B5563] leading-snug">Secondary high-reduction impact crushing for exact sizing.</p>
 </div>
 </div>
 </div>
...
const CaseStudyPage3 = () => {
 ...
 <p className="text-[13px] text-[#4B5563] leading-snug">Local granite loaded directly on road-site hopper.</p>
 </div>
 {/* Step 2 */}
 <div className="relative pl-6 group">
 <div className="absolute -left-[15px] top-0 w-7 h-7 rounded-full bg-[#0F172A] text-[#F2B233] flex items-center justify-center text-[12px] font-black shadow-md border-2 border-white group-hover:scale-110 transition-transform">2</div>
 <h5 className="font-bold text-[#0F172A] text-[14px] leading-none mb-1.5 uppercase tracking-wide">Skid Jaw Crusher</h5>
 <p className="text-[13px] text-[#4B5563] leading-snug">SREW mobile skid jaw performs primary reduction.</p>
 </div>
 {/* Step 3 */}
 <div className="relative pl-6 group">
 <div className="absolute -left-[15px] top-0 w-7 h-7 rounded-full bg-[#0F172A] text-[#F2B233] flex items-center justify-center text-[12px] font-black shadow-md border-2 border-white group-hover:scale-110 transition-transform">3</div>
 <h5 className="font-bold text-[#0F172A] text-[14px] leading-none mb-1.5 uppercase tracking-wide">Dismountable Screen</h5>
 <p className="text-[13px] text-[#4B5563] leading-snug">Vibrating classification screen segregates aggregate sizes.</p>
 </div>
 {/* Step 4 */}
 <div className="relative pl-6 group">
 <div className="absolute -left-[15px] top-0 w-7 h-7 rounded-full bg-[#F2B233] text-[#0F172A] flex items-center justify-center text-[12px] font-black shadow-md border-2 border-[#0F172A] group-hover:scale-110 transition-transform">4</div>
 <h5 className="font-bold text-[#0F172A] text-[14px] leading-none mb-1.5 uppercase tracking-wide">Radial Conveyors</h5>
 <p className="text-[13px] text-[#4B5563] leading-snug">Self-driven conveyors stockpile materials directly to site.</p>
 </div>
 </div>
 </div>
